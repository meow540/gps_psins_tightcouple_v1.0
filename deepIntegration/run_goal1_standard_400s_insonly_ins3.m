function summary = run_goal1_standard_400s_insonly_ins3()
% 400s Goal-1 run (ins3 profile) with INS-only takeover after spoof alarm.
...
outFile = fullfile(projectRoot, 'rt_tight_goal1_standard_400s_insonly_ins3.mat');
...
settingsOverride.trjFile = "E:\\fgi_result\\ins_simulation\\ins3_trj.mat";
settingsOverride.imuerrProfile = 'ins3';
...
settingsOverride.spoofDetPrMetricThresholdM = 5.0;
...
settingsOverride.odoNoiseStdMps = 0.06;
...
settingsOverride.odoVerticalDampGain = 0.55;
...
% Error metrics w.r.t. ins3 trajectory reference.
trjData = load('E:\\fgi_result\\ins_simulation\\ins3_trj.mat', 'trj');
trj = trjData.trj;
