...
addpath 'E:\ZCJ_GNSSINS_DeepIntegration-main\ZCJ_GNSSINS_DeepIntegration-main'
addpath include
...
trj = trjfile("E:\fgi_result\ins_simulation\ins3_trj.mat");
...
%ins3 低精度
%imuerr = imuerrset(20, 10000, 0.4, 1000);
...
if stopEpoch < roundTime
    navResults.X  = navResults.X(1:stopEpoch);
    navResults.Y  = navResults.Y(1:stopEpoch);
    navResults.Z  = navResults.Z(1:stopEpoch);
    navResults.dt = navResults.dt(1:stopEpoch);
    navResults.VX = navResults.VX(1:stopEpoch);
    navResults.VY = navResults.VY(1:stopEpoch);
    navResults.VZ = navResults.VZ(1:stopEpoch);
    navResults.df = navResults.df(1:stopEpoch);
end
