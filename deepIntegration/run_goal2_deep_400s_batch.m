...
opts = fillDefault(opts, 'deepShadowDs5ValidationProofMode', nan);
opts = fillDefault(opts, 'deepShadowDs5ValidationAnchorModeName', 'unspecified');
...
opts = fillDefault(opts, 'deepShadowTrustedAnchorPreferTruthTrj', 0);
opts = fillDefault(opts, 'deepShadowTrustedAnchorTruthUseCurrentEpoch', 0);
opts = fillDefault(opts, 'deepShadowTrustedAnchorUseInsPropagated', 0);
opts = fillDefault(opts, 'deepShadowTrustedAnchorInsPropagatedUseCurrent', 1);
opts = fillDefault(opts, 'deepShadowTrustedAnchorUseBaselineInsAlign', 0);
opts = fillDefault(opts, 'deepShadowTrustedAnchorAllowBaselineFedAnchor', 1);
opts = fillDefault(opts, 'deepShadowTrustedAnchorAllowHigherPriorityReplace', 1);
opts = fillDefault(opts, 'deepShadowTrustedAnchorRefreshSameSource', 0);
opts = fillDefault(opts, 'deepShadowTrustedAnchorRefreshOnlyS5', 0);
...
opts = fillDefault(opts, 'deepShadowDs5RefObsSeedUseBaseFallback', 1);
opts = fillDefault(opts, 'deepShadowDs5RefObsSeedMaxDevFromBaseM', 1500.0);
...
opts = fillDefault(opts, 'deepTrackGuardEnable', 1);
opts = fillDefault(opts, 'deepTrackGuardCodeFreqMinHz', 0.90 * 1.023e6);
opts = fillDefault(opts, 'deepTrackGuardCodeFreqMaxHz', 1.10 * 1.023e6);
opts = fillDefault(opts, 'deepTrackGuardCarrOffsetMaxHz', 20000.0);
opts = fillDefault(opts, 'deepTrackGuardMinBlockSize', 1);
opts = fillDefault(opts, 'deepTrackGuardMaxBlockSize', 12000);
...
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionCommonClockRebaseEachDelta', 1);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionCommonClockRebasePeriodM', 299792.458);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionCommonClockHalfPeriodRebaseEnable', 1);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionCommonClockHalfPeriodGuardM', 1500.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionCommonClockHalfPeriodPenaltyM', 220.0);
...
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterResetAtRecoveryStart', 1);
...
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAuthorityWarmStartEnable', 1);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAuthorityWarmStartEpochs', 2);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAbsAnchorEnable', 1);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAbsAnchorFreezeSec', opts.deepShadowDs5RefObsRecoveryStartSec);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAbsAnchorUseInsVel', 1);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAbsAnchorRefreshSameSource', 0);
opts = fillDefault(opts, 'deepShadowDs5AbsAnchorRefreshOnlyS5', 0);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAbsAnchorRefreshOnRefObsAccept', 1);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAbsAnchorAllowRefObsFallback', 0);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAbsAnchorRefreshMaxRefObsDiffM', 350.0);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAbsAnchorRefreshSelfHeldEnable', 0);
opts = fillDefault(opts, 'deepShadowDs5RecoveredFilterAbsAnchorRefreshTrustedMaxDiffM', 350.0);
...
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionRobustKeepSatBonusM', 18.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionCommonClockSubsetSoftMaxM', 1200.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionCommonClockSubsetHardMaxM', 3500.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionCommonClockSubsetScoreWeightM', 140.0);
...
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionPreferAbsAnchor', 0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionAbsAnchorUseHardGate', 0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionAbsAnchorSoftMaxDiffM', 900.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionAbsAnchorMaxDiffM', 1800.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionAbsAnchorScoreWeightM', 140.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionAbsAnchorPriorEnable', 1);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionAbsAnchorPriorSigmaM', 900.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionAbsAnchorPriorSoftSigmaM', 1800.0);
opts = fillDefault(opts, 'deepShadowTrustedAnchorBaselineInsAlignUseBaselineCurrent', 1);
opts = fillDefault(opts, 'deepShadowTrustedAnchorBaselineInsAlignUseCurrent', 1);
opts = fillDefault(opts, 'deepShadowTrustedAnchorBaselineInsAlignRefreshAfterStart', 0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionBootstrapEpochs', 40);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionBootstrapCorrMaxM', 700.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionBootstrapAnchorDiffMaxM', 700.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionBootstrapJumpMaxM', 900.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionResetHistoryAtRecoveryStart', 1);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionUseRecentFilterHold', 1);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionRecentFilterHoldMaxAgeEpochs', 24);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionRecentFilterHoldTrustedMaxDiffM', 350.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionAcceptedHoldTrustedMaxDiffM', 450.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionHoldPredDiffMaxM', 280.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionTailStartSec', 320.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionPreferTrustedAnchorStartSec', opts.deepShadowDs5RefObsPositionTailStartSec);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionPreferTrustedAnchorMinPriority', 40);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionPreferTrustedAnchorMaxDiffM', 220.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionTailCorrMaxM', 650.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionTailAnchorDiffMaxM', 650.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionTailJumpMaxM', 800.0);
opts = fillDefault(opts, 'deepShadowDs5RefObsPositionTailPredVelDiffMaxMps', 260.0);
...
opts = fillDefault(opts, 'deepShadowDs5RefObsTrackSnapshotAcceptEnable', 0);
...
baseOverride.deepShadowDs5ValidationProofMode = opts.deepShadowDs5ValidationProofMode;
baseOverride.deepShadowDs5ValidationAnchorModeName = opts.deepShadowDs5ValidationAnchorModeName;
...
baseOverride.deepShadowDs5RefObsSeedUseBaseFallback = opts.deepShadowDs5RefObsSeedUseBaseFallback;
baseOverride.deepShadowDs5RefObsSeedMaxDevFromBaseM = opts.deepShadowDs5RefObsSeedMaxDevFromBaseM;
...
baseOverride.deepShadowDs5RefObsPositionCommonClockRebaseEachDelta = opts.deepShadowDs5RefObsPositionCommonClockRebaseEachDelta;
...
baseOverride.deepShadowDs5RefObsPositionCommonClockHalfPeriodRebaseEnable = opts.deepShadowDs5RefObsPositionCommonClockHalfPeriodRebaseEnable;
baseOverride.deepShadowDs5RefObsPositionCommonClockHalfPeriodGuardM = opts.deepShadowDs5RefObsPositionCommonClockHalfPeriodGuardM;
baseOverride.deepShadowDs5RefObsPositionCommonClockHalfPeriodPenaltyM = opts.deepShadowDs5RefObsPositionCommonClockHalfPeriodPenaltyM;
...
baseOverride.deepShadowDs5RecoveredFilterResetAtRecoveryStart = opts.deepShadowDs5RecoveredFilterResetAtRecoveryStart;
...
baseOverride.deepShadowDs5RecoveredFilterAuthorityWarmStartEnable = opts.deepShadowDs5RecoveredFilterAuthorityWarmStartEnable;
baseOverride.deepShadowDs5RecoveredFilterAuthorityWarmStartEpochs = opts.deepShadowDs5RecoveredFilterAuthorityWarmStartEpochs;
baseOverride.deepShadowDs5RecoveredFilterAbsAnchorEnable = opts.deepShadowDs5RecoveredFilterAbsAnchorEnable;
baseOverride.deepShadowDs5RecoveredFilterAbsAnchorFreezeSec = opts.deepShadowDs5RecoveredFilterAbsAnchorFreezeSec;
baseOverride.deepShadowDs5RecoveredFilterAbsAnchorUseInsVel = opts.deepShadowDs5RecoveredFilterAbsAnchorUseInsVel;
baseOverride.deepShadowDs5RecoveredFilterAbsAnchorRefreshOnRefObsAccept = opts.deepShadowDs5RecoveredFilterAbsAnchorRefreshOnRefObsAccept;
baseOverride.deepShadowDs5RecoveredFilterAbsAnchorAllowRefObsFallback = opts.deepShadowDs5RecoveredFilterAbsAnchorAllowRefObsFallback;
baseOverride.deepShadowDs5RecoveredFilterAbsAnchorRefreshMaxRefObsDiffM = opts.deepShadowDs5RecoveredFilterAbsAnchorRefreshMaxRefObsDiffM;
baseOverride.deepShadowDs5RecoveredFilterAbsAnchorRefreshSameSource = opts.deepShadowDs5RecoveredFilterAbsAnchorRefreshSameSource;
baseOverride.deepShadowDs5AbsAnchorRefreshOnlyS5 = opts.deepShadowDs5AbsAnchorRefreshOnlyS5;
baseOverride.deepShadowDs5RecoveredFilterAbsAnchorRefreshSelfHeldEnable = opts.deepShadowDs5RecoveredFilterAbsAnchorRefreshSelfHeldEnable;
baseOverride.deepShadowDs5RecoveredFilterAbsAnchorRefreshTrustedMaxDiffM = opts.deepShadowDs5RecoveredFilterAbsAnchorRefreshTrustedMaxDiffM;
...
baseOverride.deepShadowDs5RefObsPositionPreferAbsAnchor = opts.deepShadowDs5RefObsPositionPreferAbsAnchor;
baseOverride.deepShadowDs5RefObsPositionAbsAnchorUseHardGate = opts.deepShadowDs5RefObsPositionAbsAnchorUseHardGate;
baseOverride.deepShadowDs5RefObsPositionAbsAnchorSoftMaxDiffM = opts.deepShadowDs5RefObsPositionAbsAnchorSoftMaxDiffM;
baseOverride.deepShadowDs5RefObsPositionAbsAnchorMaxDiffM = opts.deepShadowDs5RefObsPositionAbsAnchorMaxDiffM;
baseOverride.deepShadowDs5RefObsPositionAbsAnchorScoreWeightM = opts.deepShadowDs5RefObsPositionAbsAnchorScoreWeightM;
baseOverride.deepShadowDs5RefObsPositionAbsAnchorPriorEnable = opts.deepShadowDs5RefObsPositionAbsAnchorPriorEnable;
baseOverride.deepShadowDs5RefObsPositionAbsAnchorPriorSigmaM = opts.deepShadowDs5RefObsPositionAbsAnchorPriorSigmaM;
baseOverride.deepShadowDs5RefObsPositionAbsAnchorPriorSoftSigmaM = opts.deepShadowDs5RefObsPositionAbsAnchorPriorSoftSigmaM;
baseOverride.deepShadowTrustedAnchorBaselineInsAlignUseBaselineCurrent = opts.deepShadowTrustedAnchorBaselineInsAlignUseBaselineCurrent;
baseOverride.deepShadowDs5RefObsPositionBootstrapEpochs = opts.deepShadowDs5RefObsPositionBootstrapEpochs;
baseOverride.deepShadowDs5RefObsPositionBootstrapCorrMaxM = opts.deepShadowDs5RefObsPositionBootstrapCorrMaxM;
baseOverride.deepShadowDs5RefObsPositionBootstrapAnchorDiffMaxM = opts.deepShadowDs5RefObsPositionBootstrapAnchorDiffMaxM;
baseOverride.deepShadowDs5RefObsPositionBootstrapJumpMaxM = opts.deepShadowDs5RefObsPositionBootstrapJumpMaxM;
baseOverride.deepShadowDs5RefObsPositionResetHistoryAtRecoveryStart = opts.deepShadowDs5RefObsPositionResetHistoryAtRecoveryStart;
baseOverride.deepShadowDs5RefObsPositionUseRecentFilterHold = opts.deepShadowDs5RefObsPositionUseRecentFilterHold;
baseOverride.deepShadowDs5RefObsPositionRecentFilterHoldMaxAgeEpochs = opts.deepShadowDs5RefObsPositionRecentFilterHoldMaxAgeEpochs;
baseOverride.deepShadowDs5RefObsPositionRecentFilterHoldTrustedMaxDiffM = opts.deepShadowDs5RefObsPositionRecentFilterHoldTrustedMaxDiffM;
baseOverride.deepShadowDs5RefObsPositionAcceptedHoldTrustedMaxDiffM = opts.deepShadowDs5RefObsPositionAcceptedHoldTrustedMaxDiffM;
baseOverride.deepShadowDs5RefObsPositionPreferTrustedAnchorStartSec = opts.deepShadowDs5RefObsPositionPreferTrustedAnchorStartSec;
baseOverride.deepShadowDs5RefObsPositionPreferTrustedAnchorMinPriority = opts.deepShadowDs5RefObsPositionPreferTrustedAnchorMinPriority;
baseOverride.deepShadowDs5RefObsPositionPreferTrustedAnchorMaxDiffM = opts.deepShadowDs5RefObsPositionPreferTrustedAnchorMaxDiffM;
...
baseOverride.deepShadowTrustedAnchorPreferTruthTrj = opts.deepShadowTrustedAnchorPreferTruthTrj;
baseOverride.deepShadowTrustedAnchorTruthUseCurrentEpoch = opts.deepShadowTrustedAnchorTruthUseCurrentEpoch;
baseOverride.deepShadowTrustedAnchorUseInsPropagated = opts.deepShadowTrustedAnchorUseInsPropagated;
baseOverride.deepShadowTrustedAnchorInsPropagatedUseCurrent = opts.deepShadowTrustedAnchorInsPropagatedUseCurrent;
baseOverride.deepShadowTrustedAnchorUseBaselineInsAlign = opts.deepShadowTrustedAnchorUseBaselineInsAlign;
baseOverride.deepShadowTrustedAnchorAllowBaselineFedAnchor = opts.deepShadowTrustedAnchorAllowBaselineFedAnchor;
baseOverride.deepShadowTrustedAnchorAllowHigherPriorityReplace = opts.deepShadowTrustedAnchorAllowHigherPriorityReplace;
baseOverride.deepShadowTrustedAnchorRefreshSameSource = opts.deepShadowTrustedAnchorRefreshSameSource;
baseOverride.deepShadowTrustedAnchorRefreshOnlyS5 = opts.deepShadowTrustedAnchorRefreshOnlyS5;
...
baseOverride.deepShadowDs5RefObsTrackSnapshotAcceptEnable = opts.deepShadowDs5RefObsTrackSnapshotAcceptEnable;
...
deepIntegrationDir = fileparts(mfilename('fullpath'));
deepCoupleScript = prepareDeepCoupleRuntime(fileparts(deepIntegrationDir));
run(deepCoupleScript);  %#ok<RUN>
