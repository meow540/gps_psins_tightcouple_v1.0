function summary = run_goal1_standard_400s()
% Reproduce Goal-1 tight-coupling result on full 400s dataset.
% Dataset: ds5_400s.mat
...
outFile = fullfile(projectRoot, 'rt_tight_goal1_standard_400s.mat');
...
% Use 399 s to avoid tail-end IMU boundary exhaustion at nominal 400 s.
...
fprintf('\n==== Goal-1 Standard 400s Reproduction ====\n');
fprintf('Dataset: %s\n', summary.dataset);
fprintf('Output : %s\n', summary.output);
