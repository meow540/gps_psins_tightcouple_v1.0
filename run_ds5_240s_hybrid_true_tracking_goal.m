...
outPrefix = 'rt_deep_goal2_ds5_hybrid_true_tracking_goal_240s';
resultFile = [outPrefix '_ds5_240s.mat'];
...
opts.datasets = {'ds5'};
opts.roundTime = 480;          % 240 s at 0.5 s nav period
...
fprintf('\n=== DS5 240s hybrid true-tracking goal run ===\n');
...
if exist(resultFile, 'file') ~= 2
    ...
    fprintf('Expected exact 240s file was not created; using actual result file: %s\n', resultFile);
end
